...
void LIS3MDL::read()
{    
  uint8_t xlm = (uint8_t)wiringPiI2CReadReg8(m_deviceFd, OUT_X_L);
  uint8_t xhm = (uint8_t)wiringPiI2CReadReg8(m_deviceFd, OUT_X_H);
  uint8_t ylm = (uint8_t)wiringPiI2CReadReg8(m_deviceFd, OUT_Y_L);
  uint8_t yhm = (uint8_t)wiringPiI2CReadReg8(m_deviceFd, OUT_Y_H);
  uint8_t zlm = (uint8_t)wiringPiI2CReadReg8(m_deviceFd, OUT_Z_L);
  uint8_t zhm = (uint8_t)wiringPiI2CReadReg8(m_deviceFd, OUT_Z_H);
...
void LIS3MDL::vector_normalize(vector3<float> *a)
{
